...
void main()
{
    ...
    _TMP136 = dot(_TMP0.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP140 = dot(_TMP7.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP144 = dot(_TMP1.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP148 = dot(_TMP6.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP152 = dot(_TMP2.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP156 = dot(_TMP9.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    _TMP160 = dot(_TMP3.xyz, vec3( 2.12599993E-01, 7.15200007E-01, 7.22000003E-02));
    ...
    _TMP178 = abs(_a0181);
    _a0185 = _TMP116 - _TMP144;
    _TMP182 = abs(_a0185);
    _a0189 = _TMP152 - _TMP124;
    _TMP186 = abs(_a0189);
    _a0193 = _TMP124 - _TMP144;
    _TMP190 = abs(_a0193);
    _a0197 = _TMP152 - _TMP116;
    _TMP194 = abs(_a0197);
    _a0201 = _TMP124 - _TMP116;
    _TMP198 = abs(_a0201);
    _a0205 = _TMP120 - _TMP104;
    _TMP202 = abs(_a0205);
    _a0209 = _TMP148 - _TMP156;
    _TMP206 = abs(_a0209);
    _a0213 = _TMP108 - _TMP100;
    _TMP210 = abs(_a0213);
    _a0217 = _TMP140 - _TMP132;
    _TMP214 = abs(_a0217);
    _TMP16 = 2.00000000E+00*(_TMP166 + _TMP170 + _TMP174 + _TMP178) + _TMP182 + _TMP186 + -(_TMP190 + _TMP194) + 4.00000000E+00*_TMP198 + -(_TMP202 + _TMP206) + _TMP210 + _TMP214;
    ...
    _TMP232 = abs(_a0235);
    _a0239 = _TMP128 - _TMP160;
    _TMP236 = abs(_a0239);
    _a0243 = _TMP136 - _TMP112;
    _TMP240 = abs(_a0243);
    _a0247 = _TMP112 - _TMP160;
    _TMP244 = abs(_a0247);
    _a0251 = _TMP136 - _TMP128;
    _TMP248 = abs(_a0251);
    _a0255 = _TMP112 - _TMP128;
    _TMP252 = abs(_a0255);
    _a0259 = _TMP100 - _TMP132;
    _TMP256 = abs(_a0259);
    _a0263 = _TMP108 - _TMP140;
    _TMP260 = abs(_a0263);
    _a0267 = _TMP104 - _TMP156;
    _TMP264 = abs(_a0267);
    _a0271 = _TMP120 - _TMP148;
    _TMP268 = abs(_a0271);
    _TMP17 = 2.00000000E+00*(_TMP220 + _TMP224 + _TMP228 + _TMP232) + _TMP236 + _TMP240 + -(_TMP244 + _TMP248) + 4.00000000E+00*_TMP252 + -(_TMP256 + _TMP260) + _TMP264 + _TMP268;
    _d_edge = _TMP16 - _TMP17;
    _a0277 = _TMP116 - _TMP128;
    _TMP274 = abs(_a0277);
    _a0281 = _TMP112 - _TMP124;
    _TMP278 = abs(_a0281);
    ...
    _TMP294 = abs(_a0297);
    _a0301 = _TMP116 - _TMP140;
    _TMP298 = abs(_a0301);
    _a0305 = _TMP112 - _TMP148;
    _TMP302 = abs(_a0305);
    _a0309 = _TMP104 - _TMP128;
    _TMP306 = abs(_a0309);
    _a0313 = _TMP100 - _TMP124;
    _TMP310 = abs(_a0313);
    _TMP18 = 4.00000000E+00*(_TMP274 + _TMP278) + 2.00000000E+00*(_TMP282 + _TMP286 + _TMP290 + _TMP294) + -(_TMP298 + _TMP302 + _TMP306 + _TMP310);
    _a0319 = _TMP112 - _TMP116;
    _TMP316 = abs(_a0319);
    _a0323 = _TMP124 - _TMP128;
    _TMP320 = abs(_a0323);
    ...
    _TMP336 = abs(_a0339);
    _a0343 = _TMP112 - _TMP156;
    _TMP340 = abs(_a0343);
    _a0347 = _TMP124 - _TMP132;
    _TMP344 = abs(_a0347);
    _a0351 = _TMP108 - _TMP116;
    _TMP348 = abs(_a0351);
    _a0355 = _TMP120 - _TMP128;
    _TMP352 = abs(_a0355);
    _TMP19 = 4.00000000E+00*(_TMP316 + _TMP320) + 2.00000000E+00*(_TMP324 + _TMP328 + _TMP332 + _TMP336) + -(_TMP340 + _TMP344 + _TMP348 + _TMP352);
