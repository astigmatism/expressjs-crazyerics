 ...
 * @return {undef}
 */
var Emulator = (function(_Compression, config, system, title, file, key) {
    ...
    this.LoadState = function(slot, callback) {
    ...
    this.SimulateEmulatorKeypress = function(key, keyUpDelay, callback) {
        ...
        if (Module && Module.RI && Module.RI.eventHandler) {
            eventHandler = Module.RI.eventHandler;
        ...
        else if (Module && Module.JSEvents && Module.JSEvents.crazyericsKeyEventHandler) {
            
            eventHandler = Module.JSEvents.crazyericsKeyEventHandler;
    ...
    this.GetCanvasDimensions = function() {
        ...
        if (Module && Module.canvas) {
            result.width = Module.canvas.width;
            result.height = Module.canvas.height;
        }
        return result;
    };
    ...
    this.CleanUp = function() {
        ...
        if (Module) {
            try {
                Module.exit(); //calls exit on emulator ending loop (just to be safe)
            } catch (e) {
    ...
    var SetupEmulatorEventListener = function(system, title, file) {
        ...
        if (Module && Module.RI && Module.RI.eventHandler) {
            ...
            var originalHandler = Module.RI.eventHandler;
        ...
        if (Module && Module.JSEvents) {
             ...
             * @return {undefined}
             */
            Module.JSEvents.crazyericsEventListener = function(event) {
