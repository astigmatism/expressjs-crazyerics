...
*/
var cesFeatured = (function(_config, _Compression, _Preferences, _BoxArt, _Sync, _Tooltips, _PlayGameHandler, _Collections, _initialSyncPackage, _OnRemoveHandler) {
...
var AddTitle = function(gk) {
    ...
    var gameLink = new cesGameLink(_config, _BoxArt, _Tooltips, gameKey, _BOXSIZE, true, _PlayGameHandler);
