...
void main()
{
    ...
    _OUT._blur_dxdy = vec2(_dxdy.x, 0.00000000E+000);
...
void main()
{
    _TMP11 = pow(2.71828198E+000, -1.27322698E+000);
    _w010010 = 5.00000000E-001 + _TMP11;
    ...
    _TMP7 = 5.00000000E-001*(_TMP0.xyz + _TMP2.xyz);
    _color0028 = vec4(_TMP7.x, _TMP7.y, _TMP7.z, 1.00000000E+000);
