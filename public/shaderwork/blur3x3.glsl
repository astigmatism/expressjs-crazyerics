...
void main()
{
    _TMP13 = pow(2.71828198E+000, -1.27322698E+000);
    _texel0to1ratio0012 = _TMP13/(5.00000000E-001 + _TMP13);
    _sample0d_texel_offset0012 = vec2(_texel0to1ratio0012, _texel0to1ratio0012);
    _dxdy_mirror_x0012 = TEX1.xy*vec2( -1.00000000E+000, 1.00000000E+000);
    _dxdy_mirror_y0012 = TEX1.xy*vec2( 1.00000000E+000, -1.00000000E+000);
    ...
    _TMP9 = 2.50000000E-001*(_sample0a0012 + _sample0b0012 + _sample0c0012 + _TMP4.xyz);
    _color0042 = vec4(_TMP9.x, _TMP9.y, _TMP9.z, 1.00000000E+000);
