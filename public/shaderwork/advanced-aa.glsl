...
void main()
{
    ...
    if (TextureSize.x == 0.00000000E+000) { 
        _TMP1 = TextureSize.x;
    } else {
        _TMP1 = TextureSize.x;
    } 
    if (TextureSize.y == 0.00000000E+000) { 
        _TMP2 = TextureSize.y;
    } else {
        _TMP2 = TextureSize.y;
    } 
    _ps = vec2(1.00000000E+000/_TMP1, 1.00000000E+000/_TMP2);
    _dx = _ps.x*5.00000000E-001;
    _dy = _ps.y*5.00000000E-001;
    _texCoord = TexCoord.xy + vec2( 1.00000001E-007, 1.00000001E-007);
    _OUT._t1.xy = _texCoord + vec2(-_dx, 0.00000000E+000);
    _OUT._t2.xy = _texCoord + vec2(_dx, 0.00000000E+000);
    _OUT._t3.xy = _texCoord + vec2(0.00000000E+000, -_dy);
    _OUT._t4.xy = _texCoord + vec2(0.00000000E+000, _dy);
...
void main()
{
    ...
    _d1 = _TMP10 + 9.99999975E-005;
    _a0049 = _TMP2.xyz - _TMP6.xyz;
    _TMP11 = abs(_a0049);
    _TMP12 = dot(_TMP11, _dt);
    _d2 = _TMP12 + 9.99999975E-005;
    _a0053 = _TMP3.xyz - _TMP5.xyz;
    _TMP13 = abs(_a0053);
    _TMP14 = dot(_TMP13, _dt);
    _hl = _TMP14 + 9.99999975E-005;
    _a0057 = _TMP1.xyz - _TMP7.xyz;
    _TMP15 = abs(_a0057);
    _TMP16 = dot(_TMP15, _dt);
    _vl = _TMP16 + 9.99999975E-005;
    _k1 = 5.00000000E-001*(_hl + _vl);
    _k2 = 5.00000000E-001*(_d1 + _d2);
    _t1 = (_hl*(_TMP1.xyz + _TMP7.xyz) + _vl*(_TMP3.xyz + _TMP5.xyz) + _k1*_TMP4.xyz)/(2.50000000E+000*(_hl + _vl));
    _t2 = (_d1*(_TMP2.xyz + _TMP6.xyz) + _d2*(_TMP0.xyz + _TMP8.xyz) + _k2*_TMP4.xyz)/(2.50000000E+000*(_d1 + _d2));
    _a0061 = _t1 - _TMP4.xyz;
    _TMP17 = abs(_a0061);
    _TMP18 = dot(_TMP17, _dt);
    _k1 = _TMP18 + 9.99999975E-005;
    _a0065 = _t2 - _TMP4.xyz;
    _TMP19 = abs(_a0065);
    _TMP20 = dot(_TMP19, _dt);
    _k2 = _TMP20 + 9.99999975E-005;
    _TMP25 = (_k1*_t2 + _k2*_t1)/(_k1 + _k2);
    _OUT._color1 = vec4(_TMP25.x, _TMP25.y, _TMP25.z, 1.00000000E+000);
