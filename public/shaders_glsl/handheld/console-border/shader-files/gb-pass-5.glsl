...
void main()
{
	...
	vec3 color	=	mix(frame.rgb, border.rgb, border.a);

	/*
	 * This is the final console-border composition pass. The border image alpha
	 * is a blend mask for the border/glare artwork, not the alpha of the final
	 * WebGL canvas pixel. Some upstream handheld passes output alpha 0.0, which
	 * desktop RetroArch usually ignores but browser canvas compositing does not.
	 * Keep the blended RGB result and make the final output opaque.
	 */
