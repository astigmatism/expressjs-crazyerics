...
router.get('/emulatorprep100', function(req, res, next) {
    ...
    var SOURE_PATH = __dirname + '/../workspace/1.0.0/';
            ...
            async.eachSeries(emulatorfiles, function(emulatorfile, nextemulatorfile) {
                ...
                fs.stat(SOURE_PATH + '/' + emulatorfile, function(err, stats) {
                    ...
                    fs.readFile(SOURE_PATH + '/' + emulatorfile, 'utf8', function(err, content) {
                        ...
                        //prevent emulators from auto starting
                        re = /(var shouldRunNow=true;)/;
                        console.log('found auto start is set to true  ---> ' + re.test(content));
                        content = content.replace(re, 'var shouldRunNow=false;');
...
router.get('/emulatorprep176', function(req, res, next) {

    var EMULATOR_VERSION = '1.7.6-stable';
    var SOURE_PATH = __dirname + '/../workspace/RetroArch-stable-1.7.6/';
